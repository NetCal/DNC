...
public class dnc_network_model_5 implements ServerGraphFactory {
	...
	public void createServers1( ServerGraph sg, Server[] servers ) throws Exception {
		servers[0] = sg.addServer( "6", factory.createServiceCurve( "SC{(0.0,0.0),2.1052631578947367}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, false, false );
		servers[1] = sg.addServer( "5", factory.createServiceCurve( "SC{(0.0,0.0),2.1052631578947367}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, false, false );
	}
