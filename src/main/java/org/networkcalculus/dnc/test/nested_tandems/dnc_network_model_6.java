...
public class dnc_network_model_6 implements ServerGraphFactory {
	...
	public void createServers1( ServerGraph sg, Server[] servers ) throws Exception {
		servers[0] = sg.addServer( "3", factory.createServiceCurve( "SC{(0.0,0.0),1.0526315789473684}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.FIFO, false, false );
	}
