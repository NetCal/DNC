    ...
    private void decomposeIntoRateLatencies() {
        ...
        if (CalculatorConfig.getInstance().exec_service_curve_checks() && !this.isConvex()) {
            if (this.equals(CurveFactory_MPARTC_PwAffine.factory_object.createZeroDelayInfiniteBurst())) {
                ...
                rate_latencies.add(CurveFactory_MPARTC_PwAffine.factory_object.createRateLatency(NumFactory.getNumFactory().createPositiveInfinity(), NumFactory.getNumFactory().createZero()));
            } else {
