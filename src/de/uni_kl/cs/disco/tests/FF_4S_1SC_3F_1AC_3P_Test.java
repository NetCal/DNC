...
public class FF_4S_1SC_3F_1AC_3P_Test extends DncTests {
    ...
    private static void initializeBounds() {
        ...
        // TFA
        expected_results.setBounds(Analyses.TFA, Multiplexing.FIFO, f0, NumFactoryDispatch.create(5985, 64), NumFactoryDispatch.create(9425, 16));
        expected_results.setBounds(Analyses.TFA, Multiplexing.FIFO, f1, NumFactoryDispatch.create(3965, 64), NumFactoryDispatch.create(9425, 16));
        expected_results.setBounds(Analyses.TFA, Multiplexing.FIFO, f2, NumFactoryDispatch.create(885, 16), NumFactoryDispatch.create(1825, 4));
        expected_results.setBounds(Analyses.TFA, Multiplexing.ARBITRARY, f0, NumFactoryDispatch.create(6425, 36), NumFactoryDispatch.create(6125, 9));
        expected_results.setBounds(Analyses.TFA, Multiplexing.ARBITRARY, f1, NumFactoryDispatch.create(11975, 90), NumFactoryDispatch.create(6125, 9));
        expected_results.setBounds(Analyses.TFA, Multiplexing.ARBITRARY, f2, NumFactoryDispatch.create(685, 6), NumFactoryDispatch.create(1475, 3));

        // SFA
        expected_results.setBounds(Analyses.SFA, Multiplexing.FIFO, f0, NumFactoryDispatch.create(1795, 24), NumFactoryDispatch.create(3125, 8));
        expected_results.setBounds(Analyses.SFA, Multiplexing.FIFO, f1, NumFactoryDispatch.create(10715, 192), NumFactoryDispatch.create(18925, 64));
        expected_results.setBounds(Analyses.SFA, Multiplexing.FIFO, f2, NumFactoryDispatch.create(295, 6), NumFactoryDispatch.create(525, 2));
        expected_results.setBounds(Analyses.SFA, Multiplexing.ARBITRARY, f0, NumFactoryDispatch.create(875, 9), NumFactoryDispatch.create(4525, 9));
        expected_results.setBounds(Analyses.SFA, Multiplexing.ARBITRARY, f1, NumFactoryDispatch.create(2095, 27), NumFactoryDispatch.create(10925, 27));
        expected_results.setBounds(Analyses.SFA, Multiplexing.ARBITRARY, f2, NumFactoryDispatch.create(65), NumFactoryDispatch.create(1025, 3));

        // PMOO
        expected_results.setBounds(Analyses.PMOO, Multiplexing.ARBITRARY, f0, NumFactoryDispatch.create(875, 9), NumFactoryDispatch.create(4525, 9));
        expected_results.setBounds(Analyses.PMOO, Multiplexing.ARBITRARY, f1, NumFactoryDispatch.create(2095, 27), NumFactoryDispatch.create(10925, 27));
        expected_results.setBounds(Analyses.PMOO, Multiplexing.ARBITRARY, f2, NumFactoryDispatch.create(65), NumFactoryDispatch.create(1025, 3));
    }
