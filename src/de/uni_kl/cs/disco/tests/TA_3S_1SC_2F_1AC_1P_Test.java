...
public class TA_3S_1SC_2F_1AC_1P_Test extends DncTests {
    ...
    private static void initializeBounds() {
        ...
        // SFA
        expected_results.setBounds(Analyses.SFA, Multiplexing.FIFO, f0, factory.create(965, 12), factory.create(1675, 4));
        expected_results.setBounds(Analyses.SFA, Multiplexing.FIFO, f1, factory.create(965, 12), factory.create(1675, 4));
        expected_results.setBounds(Analyses.SFA, Multiplexing.ARBITRARY, f0, factory.create(320, 3), factory.create(550));
        expected_results.setBounds(Analyses.SFA, Multiplexing.ARBITRARY, f1, factory.create(320, 3), factory.create(550));

        // PMOO
        expected_results.setBounds(Analyses.PMOO, Multiplexing.ARBITRARY, f0, factory.create(250, 3), factory.create(1300, 3));
        expected_results.setBounds(Analyses.PMOO, Multiplexing.ARBITRARY, f1, factory.create(250, 3), factory.create(1300, 3));
