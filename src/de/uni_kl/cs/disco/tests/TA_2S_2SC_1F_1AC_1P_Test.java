...
public class TA_2S_2SC_1F_1AC_1P_Test extends DncTests {
    ...
    private static void initializeBounds() {
        ...
        expected_results.setBounds(Analyses.TFA, Multiplexing.ARBITRARY, f0, NumFactoryDispatch.create(31), NumFactoryDispatch.create(105));

        // SFA
        expected_results.setBounds(Analyses.SFA, Multiplexing.FIFO, f0, NumFactoryDispatch.create(121, 6), NumFactoryDispatch.create(105));
        expected_results.setBounds(Analyses.SFA, Multiplexing.ARBITRARY, f0, NumFactoryDispatch.create(121, 6), NumFactoryDispatch.create(105));

        // PMOO
        expected_results.setBounds(Analyses.PMOO, Multiplexing.ARBITRARY, f0, NumFactoryDispatch.create(121, 6), NumFactoryDispatch.create(105));
