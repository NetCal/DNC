...
public class TA_2S_1SC_2F_1AC_1P_Test extends DncTests {
    ...
    private static void initializeBounds() {
        ...
        expected_results.setBounds(Analyses.TFA, Multiplexing.ARBITRARY, f0, factory.getPositiveInfinity(), factory.create(250));
        expected_results.setBounds(Analyses.TFA, Multiplexing.ARBITRARY, f1, factory.getPositiveInfinity(), factory.create(250));
        ...
        expected_results_sinktree.setBounds(Analyses.PMOO, Multiplexing.ARBITRARY, f0, null, factory.create(250));
        expected_results_sinktree.setBounds(Analyses.PMOO, Multiplexing.ARBITRARY, f1, null, factory.create(250));
    }
