...
public class S_1SC_2F_2AC_Network implements NetworkFactory {
    ...
    private ArrivalCurve arrival_curve_0 = CurvePwAffineFactoryDispatch.createTokenBucket(ac_r_0, ac_b_0);
    private ArrivalCurve arrival_curve_1 = CurvePwAffineFactoryDispatch.createTokenBucket(ac_r_1, ac_b_1);
    ...
    public void reinitializeCurves() {
        ...
        arrival_curve_0 = CurvePwAffineFactoryDispatch.createTokenBucket(ac_r_0, ac_b_0);
        f0.setArrivalCurve(arrival_curve_0);

        arrival_curve_1 = CurvePwAffineFactoryDispatch.createTokenBucket(ac_r_1, ac_b_1);
