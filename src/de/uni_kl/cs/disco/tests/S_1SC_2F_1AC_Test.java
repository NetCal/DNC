...
public class S_1SC_2F_1AC_Test extends DncTest {
	...
	private S_1SC_2F_1AC_Test(DncTestConfig test_config) {
		super(new S_1SC_2F_1AC_Network());
	}

	@Override
	protected void initializeFlows() {
		f0 = ((S_1SC_2F_1AC_Network) network_factory).f0;
		f1 = ((S_1SC_2F_1AC_Network) network_factory).f1;
	}
