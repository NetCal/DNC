...
public class TR_7S_1SC_3F_1AC_3P_Test extends DncTests {
    ...
    private static void initializeBounds() {
        ...
        // TFA
        expected_results.setBounds(Analyses.TFA, Multiplexing.FIFO, f0, NumFactoryDispatch.create(395, 2), NumFactoryDispatch.create(1375));
        expected_results.setBounds(Analyses.TFA, Multiplexing.FIFO, f1, NumFactoryDispatch.create(875, 4), NumFactoryDispatch.create(1375));
        expected_results.setBounds(Analyses.TFA, Multiplexing.FIFO, f2, NumFactoryDispatch.create(180), NumFactoryDispatch.create(1375));
        expected_results.setBounds(Analyses.TFA, Multiplexing.ARBITRARY, f0, NumFactoryDispatch.create(660), NumFactoryDispatch.create(1375));
        expected_results.setBounds(Analyses.TFA, Multiplexing.ARBITRARY, f1, NumFactoryDispatch.create(2725, 4), NumFactoryDispatch.create(1375));
        expected_results.setBounds(Analyses.TFA, Multiplexing.ARBITRARY, f2, NumFactoryDispatch.create(1155, 2), NumFactoryDispatch.create(1375));

        // SFA
        expected_results.setBounds(Analyses.SFA, Multiplexing.FIFO, f0, NumFactoryDispatch.create(165), NumFactoryDispatch.create(1675, 2));
        expected_results.setBounds(Analyses.SFA, Multiplexing.FIFO, f1, NumFactoryDispatch.create(165), NumFactoryDispatch.create(1675, 2));
        expected_results.setBounds(Analyses.SFA, Multiplexing.FIFO, f2, NumFactoryDispatch.create(295, 2), NumFactoryDispatch.create(750));
        expected_results.setBounds(Analyses.SFA, Multiplexing.ARBITRARY, f0, NumFactoryDispatch.create(1735, 6), NumFactoryDispatch.create(4375, 3));
        expected_results.setBounds(Analyses.SFA, Multiplexing.ARBITRARY, f1, NumFactoryDispatch.create(1655, 6), NumFactoryDispatch.create(4175, 3));
        expected_results.setBounds(Analyses.SFA, Multiplexing.ARBITRARY, f2, NumFactoryDispatch.create(505, 2), NumFactoryDispatch.create(1275));

        // PMOO
        expected_results.setBounds(Analyses.PMOO, Multiplexing.ARBITRARY, f0, NumFactoryDispatch.create(355, 2), NumFactoryDispatch.create(900));
        expected_results.setBounds(Analyses.PMOO, Multiplexing.ARBITRARY, f1, NumFactoryDispatch.create(375, 2), NumFactoryDispatch.create(950));
        expected_results.setBounds(Analyses.PMOO, Multiplexing.ARBITRARY, f2, NumFactoryDispatch.create(355, 2), NumFactoryDispatch.create(900));

        // Sink-Tree PMOO at sink
        expected_results_sinktree.clear();

        expected_results_sinktree.setBounds(Analyses.PMOO, Multiplexing.ARBITRARY, f0, null, NumFactoryDispatch.create(1375));
