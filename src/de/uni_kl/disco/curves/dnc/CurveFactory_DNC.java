...
//--------------------------------------------------------------------------------------------------------------
    ...
    public ServiceCurve_DNC createServiceCurve(CurveUltAffine curve) {
...
//--------------------------------------------------------------------------------------------------------------
    ...
    public ArrivalCurve_DNC createArrivalCurve(CurveUltAffine curve) {
        return new ArrivalCurve_DNC(curve);
    }

    public ArrivalCurve_DNC createArrivalCurve(CurveUltAffine curve, boolean remove_latency) {
...
//--------------------------------------------------------------------------------------------------------------
    ...
    public MaxServiceCurve_DNC createMaxServiceCurve(CurveUltAffine curve) {
