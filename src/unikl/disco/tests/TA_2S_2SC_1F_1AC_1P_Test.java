 ...
 *
 */
public class TA_2S_2SC_1F_1AC_1P_Test extends FunctionalTests {
	...
	public TA_2S_2SC_1F_1AC_1P_Test( FunctionalTestConfig test_config ) throws Exception {
		super( test_config );
	}
	...
	private static void initializeBounds() {
		...
		expected_results.setBounds( Analyses.TFA, Multiplexing.ARBITRARY, f0, NumFactory.create( 31 ), NumFactory.create( 105 ) );

		// SFA
		expected_results.setBounds( Analyses.SFA, Multiplexing.FIFO, f0, NumFactory.create( 121, 6 ), NumFactory.create( 105 ) );
		expected_results.setBounds( Analyses.SFA, Multiplexing.ARBITRARY, f0, NumFactory.create( 121, 6 ), NumFactory.create( 105 ) );

		// PMOO
		expected_results.setBounds( Analyses.PMOO, Multiplexing.ARBITRARY, f0, NumFactory.create( 121, 6 ), NumFactory.create( 105 ) );
