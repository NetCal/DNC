...
import static unikl.disco.curves.CurveFactory.createZeroDelayInfiniteBurstMSC;
...
public class Network {
    ...
    public Server addServer(ServiceCurve service_curve) {
        return addServer(service_curve, createZeroDelayInfiniteBurstMSC(), AnalysisConfig.Multiplexing.ARBITRARY, false, false);
    }
    ...
    public Server addServer(String alias, ServiceCurve service_curve) {
        return addServer(alias, service_curve, createZeroDelayInfiniteBurstMSC(), AnalysisConfig.Multiplexing.ARBITRARY, false, false);
    }
